...
$output = '';
$stretch = (!empty($atts['stretch'])) ? $atts['stretch'] : '';
...
<div <?php echo implode(' ', $wrapper_attributes); ?>>
	<?php $innerColumnClass = 'vc_column-inner ' . esc_attr(trim(vc_shortcode_custom_css_class($css))); ?>
    <div class="<?php echo trim($innerColumnClass); ?>">
